                ...
                <div className="relative z-10 max-w-[1280px] mx-auto px-4 sm:px-5">
                    <div className="text-center">
                        <h1 className="text-[2.5rem] sm:text-[3rem] md:text-[4rem] lg:text-[5rem] xl:text-[6rem] font-extrabold mb-5 sm:mb-6 md:mb-7 px-2">
                            <span className="text-white drop-shadow-2xl">Digital Solutions by </span>
                        ...
                        <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl max-w-4xl mx-auto px-4 font-semibold leading-relaxed">
                            <span className="text-white drop-shadow-2xl">We bring </span>
                            <span className="text-accent font-bold drop-shadow-2xl">deep domain expertise</span>
                            <span className="text-white drop-shadow-2xl"> to every project, understanding your </span>
                            <span className="text-accent font-bold drop-shadow-2xl">regulatory requirements</span>
                            <span className="text-white drop-shadow-2xl"> and </span>
                            <span className="text-accent font-bold drop-shadow-2xl">user behaviors</span>
                        </p>
                    </div>
                </div>
            </section>
