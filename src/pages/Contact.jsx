        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="relative pt-24 sm:pt-28 md:pt-32 pb-14 sm:pb-18 md:pb-22 overflow-hidden">
                ...
                <div className="relative z-10 max-w-[1280px] mx-auto px-4 sm:px-5 text-center">
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold mb-5 sm:mb-6 md:mb-7 px-2" style={{ textShadow: '0 4px 20px rgba(0,0,0,0.5), 0 2px 10px rgba(0,0,0,0.3)' }}>
                    ...
                    <p className="text-xl sm:text-2xl md:text-3xl text-gray-900 max-w-3xl mx-auto px-4 font-bold leading-relaxed" style={{ textShadow: '0 3px 15px rgba(0,0,0,0.4), 0 2px 8px rgba(0,0,0,0.2)' }}>
